      ...
      <div className="flex items-center gap-6 lg:gap-10">
        <div className="hidden md:flex items-center gap-8">
          ...
          {isOnBlogPage ? (
            ...
            <Link to="/blogs" className="bg-white/10 hover:bg-white/20 px-6 py-2 rounded-full text-xl font-bold transition-all">
              Blogs
            </Link>
          )}
        </div>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[9px] text-zinc-500 font-black uppercase mt-1 tracking-widest">Trekker</p>
            </div>
            <div className="relative">
              <img 
                src={user?.avatar || "https://via.placeholder.com/40"} 
                className={`w-10 h-10 lg:w-11 lg:h-11 rounded-full object-cover border-2 transition-all ${showDropdown ? 'border-emerald-500' : 'border-white/10 group-hover:border-white/30'}`}
              />
